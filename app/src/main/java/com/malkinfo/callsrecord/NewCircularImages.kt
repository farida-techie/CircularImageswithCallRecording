...
class NewCircularImages : androidx.appcompat.widget.AppCompatImageView {
    ...
    public override fun onDraw(canvas: Canvas) {
        ...
        if (image != null) {
            ...
            canvas.drawCircle((circleCenter + borderWidth).toFloat(), (circleCenter + borderWidth).toFloat(), circleCenter + borderWidth - 4.0f, paintBorder!!)
